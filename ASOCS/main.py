...
def update_oled(oled, data, menu):
    oled.fill(0)
    if menu:
        pass
    else:
...
rtc_oled = busio.I2C(board.GP13, board.GP12)#create an i2c object on pins 18 and 19
...
oled = adafruit_ssd1306.SSD1306_I2C(128, 64, rtc_oled)#initialize the lcd
oled.fill(1)
oled.show()
time.sleep(0.5)
oled.fill(0)
